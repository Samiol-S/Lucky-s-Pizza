...
<div class="about-container">
  <div class="about-sub-container">
    <div class="left-side">
      <h2 class="css-h2">
        Skip The Wait, <br>
        <span style="color: var(--color-accent);">Order Online</span>
      </h2>
      <p class="about-p">
        Or just give us a call at: <br>
        &middot; 310.853.3419 <span style="color: var(--color-accent);">Canoga Park</span><br>
        &middot; 310.344.2610 <span style="color: var(--color-accent);">Gardena</span>
      </p>
...
<style>
  ...
  .about-image {
    background-image: url("/images/raw_pizza.png");
    background-size: 125%;
